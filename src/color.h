...
typedef enum {
	SCH_TAB_ACTIVE = 1,
	SCH_TAB_INACTIVE,
	SCH_TAB_ACTIVE_DIRTY,
	SCH_TAB_INACTIVE_DIRTY,
	SCH_TAB_SPACE,
	SCH_BUFFER,
	SCH_LINE_NUM,
	SCH_TERM,
...
#define CS_TAB_ACTIVE_DIRTY	COLOR_PAIR(SCH_TAB_ACTIVE_DIRTY)
#define CS_TAB_INACTIVE_DIRTY	COLOR_PAIR(SCH_TAB_INACTIVE_DIRTY)
